...
def receipt():
    ...
    def reportshot():
        ...
        filename = filedialog.asksaveasfilename(filetypes=data, initialdir=r'C:\Users\NCS\Desktop\Reciepts',
...
def receipt_hist():
    ...
    def open_dialog():
        name = filedialog.askopenfilename(initialdir= r'C:\Users\NCS\Desktop\Reciepts', title='Select Receipt',
